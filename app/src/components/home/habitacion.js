...
const Habitacion = () => {
    return (
        <div style={{ backgroundImage: `url(${fondo})`, backgroundSize: 'cover', backgroundPosition: 'center', minHeight: '100vh' }}>
            <Navbar/>
            <h1 style={{ textAlign: 'center', paddingTop: '20px' }}>Reserva tu habitación</h1>
            <Box display="flex" justifyContent="center">
                <div style={{ display: 'flex', justifyContent: 'space-between', width: '80%' }}>
                    <Tarjeta titulo="Habitacion Simple" contenido="¿Estás buscando un lugar cómodo y tranquilo para tu próxima escapada? ¡No busques más! Nuestra habitación individual es perfecta para viajeros solitarios que desean un espacio íntimo y acogedor para descansar."  imagen={image1}/>
                    <Tarjeta titulo="Habitacion Doble" contenido="¿Estás buscando un lugar cómodo y tranquilo para tu próxima escapada con un amigo o familiar? ¡No busques más! Nuestra habitación con dos camas individuales es perfecta para aquellos que desean un espacio acogedor para descansar y compartir momentos especiales juntos." imagen={image2}/>
                    <Tarjeta titulo="Habitacion Triple" contenido="¿Estás planeando una escapada con amigos o familiares? ¡Tenemos la solución perfecta para ti! Nuestra habitación con tres camas es ideal para grupos pequeños que buscan comodidad y conveniencia durante su estadía." imagen={image3}/>
                </div>
            </Box>
        </div>
    )
